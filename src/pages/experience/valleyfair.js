...
export default function Test() {
  return (
    <Container maxW="4xl" bg="gray.300" minH="calc(100vh - 200px)">
      <VStack>
        <Heading>Valleyfair Amusement Park</Heading>
      ...
      <UnorderedList>
        <ListItem>
          Co-supervised the foods department, including 50 employees, 11 food stands, and $90,000 daily revenue. Oversaw
          the Team Leads in successfully managing each individual food stand. Managed time cards and assisted in
          adjusting schedules.
        </ListItem>
      </UnorderedList>
      ...
      <UnorderedList>
        <ListItem>
          Led a team of 15 employees in daily operations of Beach Bites food stand with over $1M in annual sales.
          Responsible for training, inventory, health standard compliance, and customer service. Awarded Associate of
